...
\paragraph{Excess degree distribution.}For this we need the the excess degree distribution $q_k$. 
...
\paragraph{Probability that random link does not lead to node in the giant component.}Substituting into the self-consistency condition yields
\eqa{
...
\paragraph{Giant component size.}We can now compute the giant component size as 
\eqa{
s&=&1-\sum p_k v^k \\
