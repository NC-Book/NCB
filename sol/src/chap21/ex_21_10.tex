...
To find the long term behavior we need to find the eigenvector with eigenvalue 0. (There needs to be one. Otherwise, the walker number would not be conserved.)
Since we already know that the eigenvalue we are looking for is zero, we can move straight to the conditions 
\eqa{
0 &=& -3v_1 + v_2 \\
0 &=& -3v_2 +2v_1 + v_3 \\
0 &=& -v_3 + v_1 + 2v_2 
