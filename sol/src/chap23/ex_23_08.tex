...
So, this is slightly more than 50\%. We defined $R^*$ to be the result in this case to make it easier to talk about it later. 
...
Conversely, the chance of finding the walker in node 2 when checking at time 1 is 
\eq{
...
So in the scenario where we check on the system at time 1 but we do not know the result yet the expected result for the probabilility of finding the walker in node 1 at time 2 is 
\eqa{
R&=& p_1 R_1 + p_2 R_2 \\
