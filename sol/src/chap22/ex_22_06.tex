...
\eqa{
J_{11}&=&\left.\frac{\partial \dot{x}}{\partial x}\right|_* = \left.  \frac{8x+1}{5}-y\right|_* = 4/5 \\ 
...
\solution
We know that in two dimensional systems, Hopf-like bifurcations can only occur when the trace of the Jacobian is zero. Hence, we consider the trace of ${\bf P} - \kappa {\bf C}$ which is 
\eq{
...
The stability can only change in a bifurcation and the first bifurcation that occurs when we increase $w$ is the Turing bifurcation at
\eq{
