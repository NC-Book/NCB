...
Compare this with the Jacobian of a single isolated node (where there is nowhere to go and hence also no departures) 
\eq{
...
\eq{
0 = -(4/5-\kappa a) + (1+\kappa a) = 1/5 +2\kappa a
}
