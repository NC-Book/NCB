\exercise{Abstract sensitivity example\label{exBrainSense}}{2}
You study an ODE that is quite complicated,
\eqn{
\dot{x} = -x^4 + 2px^3 + 2p^2x - px^2 + x - 2p
}
However, you know that in the real world system $p=1$, $x=2$.  
\subquestion
...
\subquestion
Use the implicit function theorem to estimate how the steady state will respond if $p$ is changed a little bit. 
