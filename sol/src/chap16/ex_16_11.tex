...
which confirms that $p=1$ is a bifurcation. Normally we would expect this to indicate a fold bifurcation, so let's show that one of the genericity conditions of the fold is broken. We compute
\eqa{
f_{\rm p} &=&   \left. \partial_p (x-1-p)(2p-x) \right|_{x=2,p=1} \\ 
  &=&   \left. -(2p-x)+2(x-1-p) \right|_{x=2,p=1} \\
  &=&  -0+2(0) = 0
}
Hence the genericity condition of the fold bifurcation $f_{\rm p}\neq 0$ is broken. As we already suspected, this proves that this is not the fold. The two conditions 
\eq{
   f_{\rm p}=0 \qqq f_{\rm x}=0 
}
are the bifurcation conditions of the transcritical bifurcation, but is it really a transcritical bifurcation or something more special? We can find out by testing the genericity conditions of the transcritical bifurcation, $f_{\rm xp}\neq 0$ and $f_{\rm xx}\neq 0$. 
