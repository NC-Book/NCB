...
where the bifurcation point is now at $a=0$  the steady state at $x^*=0$ is stable before the bifurcation ($a<0$). For the bifurcation to show supercritical behavior we need another steady state to be present at $a>0$. In other words we want a stable, positive steady state to exist for $a>0$. 
...
Hence the bifurcation behaves supercritically if $f_{\rm xx}<0$ and subcritically if $f_{\rm xx}>0$.
