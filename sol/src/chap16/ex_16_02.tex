...
This means we have either two steady states ($b p/a<0$) or none ($bp/a>0$). If $a$ and $b$ have the same sign, then steady states exist at negative values of $p$, otherwise they only exist at positive values of $p$. 
...
If $a>0$ then the positive steady state is unstable and the negative one is stable. For $a<0$ it's the other way around. 
