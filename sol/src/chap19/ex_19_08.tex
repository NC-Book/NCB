...
where $\bf J$ is the Jacobian in $\vec{x}=\vec{0}$. Technically this is a linear system. We are already almost done, but we still have to find out what $\bf J$ is. For this purpose we use the definition 
\eq{
