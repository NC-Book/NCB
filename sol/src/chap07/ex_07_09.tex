...
Now assume we have two links, which we call `link 1' and `link 2.' The probability that the first endpoint of link 1 is on the same node as the first endpoint of link 2 is $1/N$. Since there are four such combination that would put an endpoint of link one on the same node as an endpoint of link 2 the probability that the links form a three chain is $4/N$. 
