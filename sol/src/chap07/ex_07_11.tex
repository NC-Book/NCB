...
\end{center}
But how was this figure actually made? Here we illustrate the underlying calculations with the example $z=2$.
...
\paragraph{Conclusion.}Probability densities are convenient to interpret visually as the integral over the curve should always be 1. Hence even of networks are now described by curves that have the same volume under the curve. 
