...
\solution
\paragraph{Mean degree and triangles.} To compute the mean degree, we note that there are 3 nodes of degree one 3 nodes of degree three, 4 nodes of degree four, and 1 node of degree six. We find the mean degree by computing the average
\eq{
...
three-node chains in the network. 
\paragraph{Clustering coefficient.}We can now compute the clustering coefficient 
\eq{
