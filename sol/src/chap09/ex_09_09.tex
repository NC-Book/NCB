...
[Hint: You might want to use the result of Ex.~9.8]

\solution 
\paragraph{Part (a).}For part (a) we define the generating function
\eq{
G=\sum c_k x^k
}
...
\paragraph{Part (b).}For part (b) we start again by defining 
\eq{
G=\sum c_k x^k 
}
