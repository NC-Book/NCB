...
\solution 
To show that a degree distribution is properly normalized we need to check $G(1)=1$. 
\paragraph{Regular graph.}For the regular graph (Ex 9.3 a) 
\eq{
G= x^3 
}
and hence 
...
\paragraph{Heterogeneous network.}For the heterogeneous network (Ex 9.3 b) 
\eq{
G=\frac{x^{10}+x^{20}}{2} 
}
and hence 
...
\paragraph{ER graph.}For the ER graph (Ex 9.3 c) the generating function is 
\eq{
G=\exp{z(x-1)}
}
and hence 
...
\paragraph{Mixd network.}Finally, for the mixed network (Ex 9.3 d) the generating function was  
\eq{
...
\subquestion Compute the networks' mean degree. 
...
\paragraph{Regular graph.}For the regular graph (Ex 9.3 a) we know 
\eq{
G'=3x^4 \qqq  z=3
}
hence 
...
\paragraph{Heterogeneous network.}For the heterogeneous network (Ex 9.3 b) we know
\eq{
...
\paragraph{ER graph.}For the ER graph (Ex 9.3 c) we know 
\eq{
...
\paragraph{Mixd network.}Finally, for the mixed network (Ex 9.3 d) we know  
\eq{
