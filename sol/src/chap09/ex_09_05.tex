...
\subquestion Use $Y=xQ(Y)$ to determine the generating function $Y$ that generates the number of nodes in a branch. 
...
\subquestion Use $C=xG(Y)$ to find the function $C$ that generates the component size distribution and explain the result.
