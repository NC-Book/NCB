...
\eq{
    F_3 = \frac{\phi^3-\bar{\phi}^3}{\sqrt{5}} = \frac{(1+3\sqrt{5}+15+5\sqrt5)-(1-3\sqrt5+15-5\sqrt{5})}{8\sqrt{5}} = \frac{16\sqrt{5}}{8\sqrt{5}} =2  
}
\eq{
    F_4 = \frac{\phi^4-\bar{\phi}^4}{\sqrt{5}} = \frac{(1+4\sqrt{5}+30+20\sqrt5+25)-(1-4\sqrt{5}+30-20\sqrt5+25)} {16\sqrt{5}} =\frac{48\sqrt{5}}{16\sqrt{5}} = 3  
}
