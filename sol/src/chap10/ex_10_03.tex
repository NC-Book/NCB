...
\subquestion 
A configuration model network has mean excess degree $q=5$. We attack it by random node removal. What proportion of nodes do we have to remove to break the giant component?
