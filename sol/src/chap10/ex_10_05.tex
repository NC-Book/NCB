...
\exercise{Targeted attack}{2}\label{exAttackAbsTarg}Consider an ER random graph of $N$ nodes with mean degree $z$. An attack removes all nodes of degree 0, half the nodes of degree 1, a quarter of the nodes of degree 2 and so on. Compute the size of the network $N_{\rm a}$, and the mean excess degree $q_{\rm a}$ after the attack. 
...
Hence, the mean excess degree after the attack is 
\eq{
