...
\subquestion There is also a species of rabbits on the islands. They also can only survive by forming a giant component of connected populations. But, they are surprisingly good swimmers so they can use all the links between islands, though thy can't colonize any islands where sheep are present. On what proportion of islands would you expect rabbits?
