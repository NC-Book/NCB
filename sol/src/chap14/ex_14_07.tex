...
carrying capacity, which can be interpreted as an indicator for the amount of nutrients available to the prey. All three of these quantitites are measured in some arbitrary units (e.g.~tonnes of biomass, not number of individuals).
