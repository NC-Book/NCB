...
where we define the $a$ as the rate constant for raising kits, $b$ the rate constant for becoming pregnant, $m$ the number of male kits per litter, and $f$ the number of female kits per litter. 

\subquestion Assume that becoming pregnant is a much faster process than raising kits. Then, use the Tikhonov-Fenichel reduction to formulate a model for the total number of males $M$ and females $X=P+F$. 
