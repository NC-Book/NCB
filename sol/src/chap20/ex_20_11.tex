...
\solution 
Consider a vector of the form $\vec{v}=(1,1,\ldots)^{\rm T}$. If we multiply this vector by the adjacency matrix, the $i$-th element of the resulting vector will be 
\eq{
...
\subquestion The highest node degree is an upper bound for the largest eigenvalue in any network. 
...
Because the rightmost eigenvalue is the maximum value of the Rayleigh quotient it must be at least $z$.
