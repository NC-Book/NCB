...
\paragraph{Random employee's average number of friends.} Instead let's compute the expected number of friends that Bob has in addition to Ada. This is the mean excess degree 
\eqa{
q&=&\sum k q_k \\
