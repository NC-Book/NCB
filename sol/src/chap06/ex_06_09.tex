...
\subquestion 
What is the expected number of people that are infected by the people that X infects (assume a locally treelike network without degree correlations) 
...
I am writing this solution on March 28, 2020. I haven't left my house for nearly two weeks as I am self-isolating during the CoViD-19 pandemic. The zombie disease considered in this exercise is much more virulent than Covid, but the same mathematics apply. Today the official number of infected in the US is 100.000. Even this high number means that a randomly picked person in the US is infected is only 0.3\%, so our assumption that none of X's contacts are infected before X infects them is still a very good approximation. 