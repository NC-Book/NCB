...
The average number of SI-links per I-node is $K_{\rm SI}/I$. Multiplying the rate of recovery events, $rI$, we find the production rate of SS-links from recovery to be 
\eq{
