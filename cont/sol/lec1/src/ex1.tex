...
\exercise{Terminology\hint{Level 1}{The exercises of level one recap some basics that you will need. If you don't make progress within a few minutes check out the solution.}}{1}
